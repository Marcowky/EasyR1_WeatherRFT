...
EXPERIMENT_NAME=qwen2_5_7b_weatherrft_grpo_all_logic_reward

CONFIG_PATH=weatherrft/config.yaml

TRAIN_FILE=/home/kaiyu/Project/ICASSP_weatherrft/WeatherRFT/data/dataset/WeatherCQ/EasyR1/WeatherCQ_dataset_deepseek_v3_en/train.json
